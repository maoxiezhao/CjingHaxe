...
class Scroll extends Control {
    ...
    public var scrollv: gui.mint.Control;
    public var container: gui.mint.Control;
...
//Public API
    ...
    public function new(_options:ScrollOptions) {
        ...
        container = new gui.mint.Control({
            parent : this,
            name: '$name.container',
            mouse_input: true,
