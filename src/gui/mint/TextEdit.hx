...
import gui.mint.Label;

import gui.mint.types.Types;
import gui.mint.core.Signal;
import gui.mint.types.Types.Helper;
import gui.mint.core.Macros.*;

using gui.mint.core.unifill.Unifill;
...
typedef TextEditOptions = {
    ...
    @:optional var align: gui.mint.types.Types.TextAlign;
        /** The text alignment on the vertical axis, relative to the bounds */
    @:optional var align_vertical: gui.mint.types.Types.TextAlign;
