...
class TextEdit extends gui.mint.render.Render {

    public var textedit : gui.mint.TextEdit;
    ...
    public function new( _render:LuxeMintRender, _control:gui.mint.TextEdit ) {
    ...
    //cursor
        ...
        function update_cursor() {
            ...
            var _text_visual = (cast textedit.label.renderer:gui.mint.render.luxe.Label).text;
