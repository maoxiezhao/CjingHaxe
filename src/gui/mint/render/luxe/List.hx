...
class List extends gui.mint.render.Render {

    public var list : gui.mint.List;

    var render: LuxeMintRender;

    public function new( _render:LuxeMintRender, _control:gui.mint.List ) {
    ...
    function onitementer(idx, ctrl:gui.mint.Control, e) {
        if(!selected) {
