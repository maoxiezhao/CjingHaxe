...
class Dropdown extends gui.mint.render.Render {

    public var dropdown : gui.mint.Dropdown;
    ...
    public function new( _render:LuxeMintRender, _control:gui.mint.Dropdown ) {
