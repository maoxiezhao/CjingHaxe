...
class Progress extends gui.mint.render.Render {

    public var progress : gui.mint.Progress;
    ...
    public function new( _render:LuxeMintRender, _control:gui.mint.Progress ) {
